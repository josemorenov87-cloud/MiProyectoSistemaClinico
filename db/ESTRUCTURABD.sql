CREATE DATABASE centro_clinico_v2;
USE centro_clinico_v2;

/* Tabla Usuarios */

CREATE TABLE tb_users(
dni_user VARCHAR(10) PRIMARY KEY,
...
INSERT INTO tb_users (dni_user, name_user, email_user, username, pass_user, rol_user) 
VALUES ('44669415', 'Jose Moreno', 'jam061187@gmail.com', 'jmoreno', 'jmoreno', '1');
...
CREATE TABLE tb_cie10(
id_cie10 INT PRIMARY KEY AUTO_INCREMENT,
esp_cie10 INT	NOT NULL,
diag_cie10 VARCHAR(150)
);

SELECT * FROM tb_cie10;


INSERT INTO tb_cie10(esp_cie10, diag_cie10) VALUES
('13', 'O00 - EMBARAZO ECTÓPICO'),
('13', 'O01 - MOLA HIDATIFORME'),
('13', 'O02 - OTROS PRODUCTOS ANORMALES DE LA CONCEPCIÓN'),
('13', 'O03 - ABORTO ESPONTÁNEO'),
('13', 'O04 - ABORTO MÉDICO'),
('13', 'O10 - HIPERTENSIÓN PREEXISTENTE QUE COMPLICA EL EMBARAZO, PARTO Y PUERPERIO'),
('13', 'O14 - PREECLAMPSIA'),
('13', 'O15 - ECLAMPSIA'),
('13', 'O16 - HIPERTENSIÓN MATERNA NO ESPECIFICADA'),
('13', 'O20 - HEMORRAGIA EN LA PRIMERA MITAD DEL EMBARAZO'),
('13', 'O24 - DIABETES MELLITUS EN EL EMBARAZO'),
('13', 'O30 - EMBARAZO MÚLTIPLE'),
('13', 'O36 - PROBLEMAS DE CRECIMIENTO Y BIENESTAR FETAL'),
('13', 'O42 - RUPTURA PREMATURA DE MEMBRANAS'),
('13', 'O60 - PARTO PREMATURO'),
('13', 'O72 - HEMORRAGIA POSTPARTO'),
('13', 'O80 - PARTO ÚNICO ESPONTÁNEO'),
('13', 'O82 - PARTO POR CESÁREA'),
('13', 'O85 - SEPSIS PUERPERAL'),
('13', 'O99 - OTRAS ENFERMEDADES MATERNAS QUE COMPLICAN EL EMBARAZO Y PARTO'),
('13', 'N70 - SALPINGITIS Y OOFORITIS'),
('13', 'N71 - ENFERMEDAD INFLAMATORIA DEL ÚTERO, EXCEPTO CUELLO UTERINO'),
('13', 'N72 - ENFERMEDAD INFLAMATORIA DEL CUELLO UTERINO'),
('13', 'N73 - OTRAS ENFERMEDADES PÉLVICAS INFLAMATORIAS FEMENINAS'),
('13', 'N75 - ENFERMEDADES DE LA GLÁNDULA DE BARTHOLIN'),
('13', 'N80 - ENDOMETRIOSIS'),
('13', 'N81 - PROLAPSO DE ÓRGANOS GENITALES FEMENINOS'),
('13', 'N82 - FÍSTULAS DEL TRACTO GENITAL FEMENINO'),
('13', 'N83 - TRASTORNOS NO INFLAMATORIOS DEL OVARIO, TROMPA Y LIGAMENTO ANCHO'),
('13', 'N84 - PÓLIPO DEL TRACTO GENITAL FEMENINO'),
('13', 'N85 - TRASTORNOS NO INFLAMATORIOS DEL ÚTERO, EXCEPTO CUELLO'),
('13', 'N86 - EROSIÓN Y ECTROPIÓN DEL CUELLO UTERINO'),
('13', 'N87 - DISPLASIA CERVICAL'),
('13', 'N92 - MENSTRUACIÓN EXCESIVA, FRECUENTE E IRREGULAR'),
('13', 'N93 - HEMORRAGIA UTERINA Y VAGINAL ANORMAL'),
('13', 'N95 - TRASTORNOS MENOPÁUSICOS Y PERIMENOPÁUSICOS'),
('13', 'N97 - INFERTILIDAD FEMENINA'),
('13', 'N98 - COMPLICACIONES ASOCIADAS A LA FECUNDACIÓN ARTIFICIAL'),
('13', 'C51 - NEOPLASIA MALIGNA DE LA VULVA'),
('13', 'C52 - NEOPLASIA MALIGNA DE LA VAGINA'),
('13', 'C53 - NEOPLASIA MALIGNA DEL CUELLO UTERINO'),
('13', 'C54 - NEOPLASIA MALIGNA DEL CUERPO UTERINO'),
('13', 'C55 - NEOPLASIA MALIGNA DEL ÚTERO, PARTE NO ESPECIFICADA'),
('13', 'C56 - NEOPLASIA MALIGNA DEL OVARIO'),
('13', 'C57 - NEOPLASIA MALIGNA DE OTROS ÓRGANOS GENITALES FEMENINOS'),
('13', 'C58 - NEOPLASIA MALIGNA DE LA PLACENTA'),
('13', 'Q50 - MALFORMACIONES CONGÉNITAS DE OVARIOS, TROMPAS Y LIGAMENTOS ANCHOS'),
('13', 'Q51 - MALFORMACIONES CONGÉNITAS DEL ÚTERO Y CUELLO UTERINO'),
('13', 'Q52 - OTRAS MALFORMACIONES CONGÉNITAS DE LOS GENITALES FEMENINOS'),
('13', 'Q56 - SEXO INDETERMINADO E INTERSEXUALIDAD'),
('13', 'Z30 - ATENCIÓN PARA ANTICONCEPCIÓN'),
('13', 'Z31 - ATENCIÓN PARA REPRODUCCIÓN ASISTIDA'),
('13', 'Z32 - EXAMEN DE EMBARAZO'),
('13', 'Z33 - ESTADO DE EMBARAZO'),
('13', 'Z34 - SUPERVISIÓN DE EMBARAZO NORMAL'),
('13', 'Z35 - SUPERVISIÓN DE EMBARAZO DE ALTO RIESGO'),
('13', 'Z36 - EXAMEN PRENATAL'),
('13', 'Z37 - RESULTADO DEL PARTO'),
('13', 'Z39 - ATENCIÓN Y EXAMEN POSTPARTO'),
('36', 'F00 - DEMENCIA EN LA ENFERMEDAD DE ALZHEIMER'),
('36', 'F01 - DEMENCIA VASCULAR'),
('36', 'F02 - DEMENCIA EN OTRAS ENFERMEDADES CLASIFICADAS EN OTRA PARTE'),
('36', 'F03 - DEMENCIA NO ESPECIFICADA'),
('36', 'F04 - SÍNDROME AMNÉSICO ORGÁNICO, NO INDUCIDO POR ALCOHOL U OTRAS SUSTANCIAS PSICOACTIVAS'),
('36', 'F05 - DELIRIO, NO INDUCIDO POR ALCOHOL U OTRAS SUSTANCIAS PSICOACTIVAS'),
('36', 'F06 - OTROS TRASTORNOS MENTALES DEBIDOS A LESIÓN O DISFUNCIÓN CEREBRAL O A ENFERMEDAD SOMÁTICA'),
('36', 'F07 - TRASTORNOS DE LA PERSONALIDAD Y DEL COMPORTAMIENTO DEBIDOS A ENFERMEDAD, LESIÓN O DISFUNCIÓN CEREBRAL'),
('36', 'F09 - TRASTORNO MENTAL ORGÁNICO O SINTOMÁTICO NO ESPECIFICADO'),
('36', 'F10 - TRASTORNOS MENTALES Y DEL COMPORTAMIENTO DEBIDOS AL CONSUMO DE ALCOHOL'),
('36', 'F11 - TRASTORNOS DEBIDOS AL CONSUMO DE OPIOIDES'),
('36', 'F12 - TRASTORNOS DEBIDOS AL CONSUMO DE CANNABINOIDES'),
('36', 'F13 - TRASTORNOS DEBIDOS AL CONSUMO DE SEDANTES O HIPNÓTICOS'),
('36', 'F14 - TRASTORNOS DEBIDOS AL CONSUMO DE COCAÍNA'),
('36', 'F15 - TRASTORNOS DEBIDOS AL CONSUMO DE OTROS ESTIMULANTES, INCLUIDA LA CAFEÍNA'),
('36', 'F16 - TRASTORNOS DEBIDOS AL CONSUMO DE ALUCINÓGENOS'),
('36', 'F17 - TRASTORNOS DEBIDOS AL CONSUMO DE TABACO'),
('36', 'F18 - TRASTORNOS DEBIDOS AL CONSUMO DE DISOLVENTES VOLÁTILES'),
('36', 'F19 - TRASTORNOS DEBIDOS AL CONSUMO DE MÚLTIPLES DROGAS Y OTRAS SUSTANCIAS PSICOACTIVAS'),
('36', 'F20 - ESQUIZOFRENIA'),
('36', 'F21 - TRASTORNO ESQUIZOTÍPICO'),
('36', 'F22 - TRASTORNOS DELIRANTES PERSISTENTES'),
('36', 'F23 - TRASTORNOS PSICÓTICOS AGUDOS Y TRANSITORIOS'),
('36', 'F24 - TRASTORNO DELIRANTE INDUCIDO'),
('36', 'F25 - TRASTORNOS ESQUIZOAFECTIVOS'),
('36', 'F28 - OTROS TRASTORNOS PSICÓTICOS NO ORGÁNICOS'),
('36', 'F29 - PSICOSIS NO ORGÁNICA NO ESPECIFICADA'),
('36', 'F30 - EPISODIO MANÍACO'),
('36', 'F31 - TRASTORNO AFECTIVO BIPOLAR'),
('36', 'F32 - EPISODIO DEPRESIVO'),
('36', 'F33 - TRASTORNO DEPRESIVO RECURRENTE'),
('36', 'F34 - TRASTORNOS DEL HUMOR PERSISTENTES'),
('36', 'F38 - OTROS TRASTORNOS DEL HUMOR'),
('36', 'F39 - TRASTORNO DEL HUMOR NO ESPECIFICADO'),
('36', 'F40 - TRASTORNOS FÓBICOS DE ANSIEDAD'),
('36', 'F41 - OTROS TRASTORNOS DE ANSIEDAD'),
('36', 'F42 - TRASTORNO OBSESIVO-COMPULSIVO'),
('36', 'F43 - REACCIONES A ESTRÉS GRAVE Y TRASTORNOS DE ADAPTACIÓN'),
('36', 'F44 - TRASTORNOS DISOCIATIVOS (DE CONVERSIÓN)'),
('36', 'F45 - TRASTORNOS SOMATOMORFOS'),
('36', 'F48 - OTROS TRASTORNOS NEURÓTICOS'),
('36', 'F50 - TRASTORNOS DE LA INGESTIÓN DE ALIMENTOS'),
('36', 'F51 - TRASTORNOS NO ORGÁNICOS DEL SUEÑO'),
('36', 'F52 - DISFUNCIÓN SEXUAL NO ORGÁNICA'),
('36', 'F53 - TRASTORNOS MENTALES Y DEL COMPORTAMIENTO ASOCIADOS AL PUERPERIO, NO CLASIFICADOS EN OTRO LUGAR'),
('36', 'F54 - FACTORES PSICOLÓGICOS Y DEL COMPORTAMIENTO ASOCIADOS CON TRASTORNOS O ENFERMEDADES CLASIFICADOS EN OTRA PARTE'),
('36', 'F55 - ABUSO DE SUSTANCIAS NO ADICTIVAS'),
('36', 'F59 - SÍNDROME DEL COMPORTAMIENTO ASOCIADO CON ALTERACIONES FISIOLÓGICAS NO ESPECIFICADO'),
('36', 'F60 - TRASTORNOS ESPECÍFICOS DE LA PERSONALIDAD'),
('36', 'F61 - TRORNOS MIXTOS Y OTROS TRASTORNOS DE LA PERSONALIDAD'),
('36', 'F62 - MODIFICACIONES DURADERAS DE LA PERSONALIDAD NO ATRIBUIBLES A LESIÓN O ENFERMEDAD CEREBRAL'),
('36', 'F63 - TRASTORNOS DE LOS HÁBITOS Y DE LOS IMPULSOS'),
('36', 'F64 - TRASTORNOS DE LA IDENTIDAD SEXUAL'),
('36', 'F65 - TRASTORNOS DE LA PREFERENCIA SEXUAL'),
('36', 'F66 - TRASTORNOS PSICOLÓGICOS Y DEL COMPORTAMIENTO ASOCIADOS CON EL DESARROLLO Y ORIENTACIÓN SEXUAL'),
('36', 'F68 - OTROS TRASTORNOS DE LA PERSONALIDAD Y DEL COMPORTAMIENTO EN EL ADULTO'),
('36', 'F69 - TRASTORNO DE LA PERSONALIDAD Y DEL COMPORTAMIENTO NO ESPECIFICADO'),
('36', 'F70 - RETRASO MENTAL LEVE'),
('36', 'F71 - RETRASO MENTAL MODERADO'),
('36', 'F72 - RETRASO MENTAL GRAVE'),
('36', 'F73 - RETRASO MENTAL PROFUNDO'),
('36', 'F78 - OTROS RETRASOS MENTALES'),
('36', 'F79 - RETRASO MENTAL NO ESPECIFICADO'),
('36', 'F80 - TRASTORNOS ESPECÍFICOS DEL DESARROLLO DEL HABLA Y DEL LENGUAJE'),
('36', 'F81 - TRASTORNOS ESPECÍFICOS DEL DESARROLLO DE LAS HABILIDADES ESCOLARES'),
('36', 'F82 - TRASTORNO ESPECÍFICO DEL DESARROLLO MOTOR'),
('36', 'F84 - TRASTORNOS GENERALIZADOS DEL DESARROLLO (INCLUYE AUTISMO INFANTIL)'),
('36', 'F88 - OTROS TRASTORNOS DEL DESARROLLO PSICOLÓGICO'),
('36', 'F89 - TRASTORNO DEL DESARROLLO PSICOLÓGICO NO ESPECIFICADO'),
('36', 'F90 - TRASTORNOS POR DÉFICIT DE ATENCIÓN Y COMPORTAMIENTO PERTURBADOR'),
('36', 'F91 - TRASTORNOS DE LA CONDUCTA'),
('36', 'F92 - TRASTORNOS MIXTOS DE LA CONDUCTA Y DE LAS EMOCIONES'),
('36', 'F93 - TRASTORNOS EMOCIONALES DE COMIENZO ESPECÍFICO EN LA INFANCIA'),
('36', 'F94 - TRASTORNOS DEL FUNCIONAMIENTO SOCIAL DE COMIENZO ESPECÍFICO EN LA INFANCIA Y ADOLESCENCIA'),
('36', 'F95 - TRASTORNOS POR TICS'),
('36', 'F98 - OTROS TRASTORNOS EMOCIONALES Y DEL COMPORTAMIENTO DE COMIENZO EN LA INFANCIA Y ADOLESCENCIA'),
('36', 'F99 - TRASTORNO MENTAL NO ESPECIFICADO')
...
SELECT e.nom_depart AS Departamento, p.nom_prov AS Provincia, d.nom_dist AS Distrito
FROM tb_distrito d
INNER JOIN tb_provincia p ON p.id_prov = d.id_prov
INNER JOIN tb_departamento e ON e.id_depart = d.id_depart
WHERE d.id_prov = 1501;
****            ****
...
desc_especialidad VARCHAR(50) UNIQUE
);

INSERT INTO tb_especialidades(desc_especialidad) VALUES
('ANATOMIA PATOLOGICA'),
('ANESTESIOLOGIA'),
('CARDIOLOGIA'),
...
;
/****************************************/
/* Tabla Grupo de examenes */
/****************************************/

DROP TABLE IF EXISTS tb_grpexam;
CREATE TABLE tb_grpexam(
id_grpexam INT PRIMARY KEY AUTO_INCREMENT,
nom_grpexam VARCHAR(50) NOT NULL
);


INSERT INTO tb_grpexam(nom_grpexam) VALUES
...
SELECT * FROM tb_grpexam
;

DROP TABLE IF EXISTS tb_tipexam;
CREATE TABLE tb_tipexam(
id_tipexam INT PRIMARY KEY AUTO_INCREMENT,
cod_grpexam INT NOT NULL,
nom_tipexam VARCHAR(50) NOT NULL
);


SELECT * FROM tb_tipexam;

INSERT INTO tb_tipexam(cod_grpexam, nom_tipexam) VALUES
('1', 'HEMOGRAMA COMPLETO'),
('1', 'CONSTANTES CORPUSCUARES'),
('1', 'PLAQUETAS'),
('1', 'HEMATOCRITO'),
('1', 'HEMOGIOBINA'),
('1', 'TIEMPO DE PROTROMBINA (PT)'),
('1', 'TIEMPO PARCIAL DE TROMBOPLASTINA (PTT)'),
('1', 'FIBRINDGENO'),
('1', 'DIMEROD'),
('1', 'BIOQUIMICA F'),
('1', 'GLUCOSA HAI'),
('1', 'COLESTEROL TOTAL Y FRACC. —TRIGLICÉRIDOS'),
('1', 'TBILRUBINA TOTALY FRACC. UREA'),
('1', 'PROTEINAS TOTALY FRACE. — —_CREATINA'),
('1', 'TRANSAMINASAS (GO Y TGP) —ACIO URICO'),
('1', 'GAMMA GLUTAMIL T. (GGT) —CALCIO'),
('1', 'FOSFATASA ALCALINA (ALP) —FÉSTORO'),
('1', 'LACTATO DESHID. (LDH) —ELECTROLITOS'),
('1', 'AMILASA (NAK.CL)'),
('1', 'LIPASA _— GASES ART'),
('1', 'PROTEINA C REACTIVA (PCR) (AGA)'),
('2', 'GLUCOSA '),
('2', 'COLESTEROL TOTAL Y FRACC.'),
('2', 'BILIRRUBINA TOTAL Y FRACC.'),
('2', 'PROTEINAS TOTAL Y FRACC.'),
('2', 'TRANSAMINASAS (TGO Y TGP)'),
('2', 'GAMMA GLUTAMIL T. (GGT)'),
('2', 'FOSFATASA ALCALINA (ALP)'),
('2', 'LACTATO DESHID. (LDH)'),
('2', 'AMILASA'),
('2', 'LIPASA'),
('2', 'PROTEINA C REACTIVA (PCR)'),
('2', 'HbA1c'),
('2', 'TRIGLICÉRIDOS'),
('2', 'UREA'),
('2', 'CREATINA'),
...
('5', 'UROCULIVO'),
('5', 'COPROCUITIVO'),
('5', 'CULTIVO SECRECION VAGINAL'),
('5', 'ESPERMOCULIVO'),
('5', 'CULTIVO DE EXUDADO FARINGEO'),
('5', 'CULTIVO DE SECRECION'),
('5', 'HEMOCUITIVO'),
('5', 'CULTIVO DE ESPUTO'),
('5', 'CULTIVO PARA HONGOS'),
('5', 'DIRECTO RASPADO'),
('5', 'DIRECTO BK'),
('6', 'AFP '),
('6', 'CEA'),
...
('7', 'PROTOCOLO 24 H'),
('7', 'ALBUMINA'),
('7', 'DEPURACION DE CREATINA'),
('7', 'DEPURACION DE UREA'),
('7', 'DEPURACION DE ACIDO ÚRICO'),
('7', 'CALCIO EN ORINA'),
('7', 'ELECTROLITOS EN ORINA'),
('7', 'UROCULTIVO'),
('7', 'ACIDO ÚRICO EN ORINA SIMPLE'),
('7', 'CREATINA EN ORINA SIMPLE'),
('8', 'COAGULACION  (PT.PTT FIBRINOGENO)'),
('8', 'HEPATICO (BILIRUBIN TOTAL FRACC.)'),
('8', '(PROTEINAS TOTAL Y FRACC. TGO, TGO,ALP)'),
('8', 'LIPIDO (COLESTEROL, C-HDL,C-LDL,CVLDL,'),
('8', 'TRIGLICÉRIDOS'),
('8', 'HORMONAL FEMENINO 1 (FSH, LH, ESTRADIOL)'),
('8', 'HORMONAL FEMENINO 2 (FSH, LH, ESTRADIOL,'),
('8', 'PROGESTRONA,PROLACINA, TETOSTERONA TOTAL Y L '),
('8', 'TORCH Ig G/IgM (TOXOPLASMOSIS, RUBÉOLA,'),
('8', 'CITOMEGAlOVIRUS, HERPES I, HERPES II)'),
('8', 'TIROIDEO (TSH, T3L, T4L)'),
('8', 'PRE-OPERATORIO(HEMOGRAMA, GRUPO S,'),
('8', 'Glicemia, UREA, CREATING, CRNA, HIV, VDRL,'),
('8', 'PT Y PTT, Ag  SUPERFICIE HEP B)'),
('8', 'PRE-NATAL (HEMOGRAMA, GRUPO S, GLISEIA,'),
('8', 'UREA CREATININA, ORINA, HIV VDRL, HBSSag}'),
('8', 'RENAL HEMOGRAMA, ORINA, UREA,'),
('8', 'DEPURACION CREATINA, PROTEINURIA 24H)'),
('9', 'PARASITOLOGICO'),
('9', 'SERIADO PARASITOLOGICO (X 3 MUESTAS)'),
('9', 'REACCION INFLAMATORIA  (LEUCOGRAMA FECAL)'),
('9', 'COPROLOGICO FUNCIONAL'),
('9', 'THEVENON (SANGRE OCULTA)'),
('9', 'AZUCARES REDUCTORES'),
('9', 'GRASAS EN HECES'),
('9', 'METODO DE CONCENTRACION'),
('9', 'TEST DE GRAHAM');

SELECT g.nom_grpexam AS 'GRUPO DE EXAMENES', t.nom_tipexam AS 'TIPO DE EXAMEN'
FROM tb_tipexam t
INNER JOIN tb_grpexam g ON t.cod_grpexam = g.id_grpexam
WHERE t.cod_grpexam = 3
;
...
name_tdoc VARCHAR(30) NOT NULL,
desc_tdoc VARCHAR (50) NOT NULL
);

SELECT * FROM tb_tipodoc
;

INSERT INTO tb_tipodoc(name_tdoc, desc_tdoc) VALUES
('Carnet de Extranjeria', 'No peruanos'),
('Doc. Nac. Identidad', 'Peruanos'),
('Pasaporte', 'Todos');

/* Tabla Tipo de Carnet de Colegiatura */
;
DROP TABLE IF EXISTS `tb_tipcoleg`;
CREATE TABLE tb_tipcoleg(
id_tcoleg INT PRIMARY KEY AUTO_INCREMENT,
abrv_coleg VARCHAR(5) NOT NULL,
desc_tipcoleg VARCHAR(35)
);

SELECT * FROM tb_tipcoleg
;

INSERT INTO tb_tipcoleg(abrv_coleg, desc_tipcoleg) VALUES
('CMP', 'Colegio Medico del Perú'),
('CPSP', 'Colegio de Psicologos del Perú');

/* Tabla Departamentos de Perú */

CREATE TABLE tb_departamento(
id_depart VARCHAR(2) PRIMARY KEY,
nom_depart VARCHAR(50) NOT NULL
);

/* Tabla Provincias de Perú */

CREATE TABLE tb_provincia(
id_prov VARCHAR(4) PRIMARY KEY,
nom_prov VARCHAR(50) NOT NULL,
id_depart VARCHAR(2) NOT NULL
);

/* Tabla Distritos de Perú */

CREATE TABLE tb_distrito(
id_dist VARCHAR (6) PRIMARY KEY,
...
tdoc_medico INT NOT NULL,
numdoc_medico VARCHAR(20) NOT NULL UNIQUE,
fnac_medico DATE	NOT NULL,
nom_medico VARCHAR(20) NOT NULL,
apepat_medico VARCHAR(20) NOT NULL,
apemat_medico VARCHAR(20),
nac_medico INT,
lnac_medico VARCHAR(50),
sex_medico CHAR NOT NULL, /* F - Femenino , M - Masculino*/
email_medico VARCHAR(50),
tel_medico VARCHAR(10),
cel_medico VARCHAR(10),
direc_medico VARCHAR(50),
depart_medico INT,
prov_medico INT,
dist_medico INT,
esp_medico INT,
tcoleg_medico INT,
numcoleg_medico VARCHAR(6) UNIQUE,
habcoleg_medico INT,
status_medico INT
);

INSERT INTO tb_medicos(tdoc_medico, numdoc_medico, fnac_medico, nom_medico, apepat_medico, sex_medico, status_medico) VALUES
('1', '4556897823', '1995-10-15', 'ALBA', 'ROMERO', 'F', '1'),
('1', '4589455632', '1987-12-16', 'DANIEL', 'VILLAMIZAR', 'M', '1'),
('1', '2585749632', '1973-09-08', 'JOSE', 'ZAMBRANO', 'M', '1'),
('1', '1232659874', '1971-05-02', 'WILDER', 'GALINDO', 'M', '1');

SELECT * FROM tb_medicos;

/* Consulta para citas */
SELECT id_medico AS 'Codigo Médico', CONCAT('DR. ',nom_medico, ' ',apepat_medico) AS 'Médico Especialista' 
FROM tb_medicos
WHERE sex_medico = 'M'
UNION ALL
SELECT id_medico AS 'Codigo Médico', CONCAT('DRA. ',nom_medico, ' ',apepat_medico) AS 'Médico Especialista' 
FROM tb_medicos
WHERE sex_medico = 'F'
ORDER BY 'Codigo Médico'
;
/* Tabla Pacientes */
;
...
tdoc_paciente INT NOT NULL,
numdoc_paciente VARCHAR(20) NOT NULL UNIQUE,
nom_paciente VARCHAR(20) NOT NULL,
apepat_paciente VARCHAR(20) NOT NULL,
apemat_paciente VARCHAR(20) NOT NULL,
fnac_paciente DATE NOT NULL,
nac_paciente INT,
lnac_paciente VARCHAR(50),
sex_paciente CHAR NOT NULL, /* F - Femenino , M - Masculino*/
email_paciente VARCHAR(50),
tel_paciente VARCHAR(10),
cel_paciente VARCHAR(10),
direc_paciente VARCHAR(50),
depart_paciente INT,
prov_paciente INT,
dist_paciente INT,
ocup_paciente INT,
prof_paciente INT,
nomce_paciente VARCHAR(50),
telce_paciente VARCHAR(10),
emailce_paciente VARCHAR(50),
est_reg_paciente INT NOT NULL /*1 - Incompleto , 2 - Completo*/
);

SELECT * FROM tb_pacientes
;
SELECT * FROM tb_pacientes
WHERE sex_paciente="m"
;

INSERT INTO tb_pacientes(tdoc_paciente, numdoc_paciente, nom_paciente, apepat_paciente, apemat_paciente, fnac_paciente, sex_paciente, est_reg_paciente) VALUES
('2', '32228669', 'ESTEFANI', 'ESCALONA', 'SEGARRA', '1978-09-16', 'F', '1'),
('2', '09735870', 'MEY GRIMANEZA', 'CELIS', 'GRANDEZ', '1973-06-19', 'F', '1'),
('2', '19183477', 'KATHERINE', 'SANTISTEBAN', 'DEL AGUILA', '1970-08-06', 'F', '1'),
('2', '11468099', 'ROSA MARIA', 'SABOYA', 'SANCHEZ', '1984-06-16', 'F', '1'),
('2', '27565265', 'KASUE RAQUEL', 'SILVA', 'TANG', '1967-07-24', 'F', '1'),
('2', '09540061', 'SHEYLA', 'PINEDO', 'CHUQUIPIONDO', '2001-04-21', 'F', '1'),
('2', '11643741', 'LESLYE', 'RODRIGUEZ', 'RIOJA', '2001-02-07', 'F', '1'),
('2', '32322492', 'ELIZABETH', 'SILVA', 'CHAVEZ', '1992-05-22', 'F', '1'),
('2', '29342586', 'RINA ANNE', 'RAMIREZ', 'LOPEZ', '1981-01-07', 'F', '1'),
('2', '37807802', 'ELSA', 'DAVILA', 'MOSQUERA', '1983-02-05', 'F', '1'),
('2', '42180121', 'DEIDAMIA', 'GONZALES', 'DE TICLLA', '2001-10-16', 'F', '1'),
('2', '13668969', 'GABRIELA', 'RODRIGUEZ', 'RUIZ', '1966-03-10', 'F', '1'),
('2', '49491004', 'DEYSI', 'ALBERCA', 'AGURTO', '2001-02-19', 'F', '1'),
('2', '39347350', 'CELINA', 'PETRAVON', 'HOEGEN', '1968-12-31', 'F', '1'),
('2', '16125981', 'LEIDY DIANA', 'COLLAZOS', 'FLORES', '1990-07-26', 'F', '1'),
('2', '33353901', 'MARY LUZ', 'BENITO', 'PALACIN', '1982-01-10', 'F', '1'),
('2', '36343121', 'FIORELLA', 'FLORES', 'SANCHEZ', '2001-05-05', 'F', '1'),
('2', '37348946', 'MARIANA', 'RIOS', 'YANQUI', '1993-07-07', 'F', '1'),
('2', '13276772', 'JESSICA', 'MACEDO', 'PINEDO', '2000-03-02', 'F', '1'),
('2', '15592847', 'CINDY', 'DEL AGUILA', 'SHAPIAMA', '1980-04-11', 'F', '1'),
('2', '34288781', 'MARIA CAROLINA', 'PEREZ', 'TELLO', '1984-06-07', 'F', '1'),
('2', '31137800', 'RODRIGO ANDRE', 'RODRIGUEZ', 'HERRERA', '1967-08-30', 'M', '1'),
('2', '18210536', 'JOSE ISAIAS', 'SANCHEZ', 'ANGULO', '1992-05-17', 'M', '1'),
('2', '17488305', 'LUIS EDUARDO', 'ZERPA', 'CASTILLO', '1982-08-07', 'M', '1'),
('2', '47156105', 'MOISES', 'MENDIETA', '', '1992-11-01', 'M', '1'),
('2', '31039020', 'DEYBERT', 'RODRIGUEZ', 'ROMAN', '1983-06-09', 'M', '1'),
('2', '42979407', 'ANDREA MARGARITA', 'ZANOTTI', 'MARTINEZ', '1994-07-06', 'F', '1'),
('2', '08248138', 'COLIN HOLDERI', 'GONZALEZ', 'LEZAMA', '1974-07-21', 'M', '1'),
('2', '16267248', 'NAIROBIC', 'BARRETO', 'NIEVES', '1988-09-29', 'M', '1'),
('2', '29603989', 'RAFAEL SIMON', 'LA ROSA', 'LOLI', '1992-01-25', 'M', '1'),
('2', '13824433', 'LOURDES PAOLA', 'CACERES', 'REBATTA', '1969-08-04', 'F', '1'),
('2', '29937162', 'JOSE', 'SALAZAR', 'DIAZ', '1971-10-23', 'M', '1'),
('2', '32131125', 'CARMEN', 'TORRES', 'DE ESCOBAR', '1980-01-21', 'F', '1')
;
...
INSERT INTO tb_citas(numdoc_paciente, id_especialidad, id_medico, fecha_cita, hora_cita, motivo_cita) VALUES
('32228669', '13', '1', '2025-11-12', '09:00', 'Control'),
('17488305', '36', '4', '2025-11-15', '11:00', 'Paciente nuevo'),
('09540061', '36', '4', '2025-11-15', '11:30', 'Terapia');


/*Consulta Especial para atención de triaje*/
SELECT c.id_cita, c.numdoc_paciente AS '# Doc. Paciente', CONCAT(p.nom_paciente, ' ',p.apepat_paciente, ' ',p.apemat_paciente) AS Paciente
FROM tb_citas c
INNER	JOIN	tb_pacientes p ON p.numdoc_paciente = c.numdoc_paciente
WHERE c.fecha_cita = '2025-11-15'

;
/******************************************/
/*** Creación de Tabla Atención General ***/
/******************************************/

CREATE TABLE tb_atengeneral(
id_atencion INT AUTO_INCREMENT PRIMARY KEY,
id_triaje INT,
id_paciente INT,
id_cie10 INT,
desc_diagnostico TEXT,
desc_antecedentes TEXT
);


/********************************/
/*** Creación de Tabla Triaje ***/
/********************************/


DROP TABLE IF EXISTS tb_triaje;
...
INSERT INTO tb_triaje (id_cita, numdoc_paciente, temp, presion, spo2, pulso, talla, peso, IMC, interp, Alergias) VALUES
('1','32228669','37.0','120/80','0.94','100','1.75','72.5','23.67','Peso Normal','Sulfas'),
('2','17488305','36.5','110/70','0.95','120','1.56','64.0','26.30','Sobrepeso','Metamisol'),
('3','09540061','38.0','100/80','0.93','80','1.64','68.0','25.28','Sobrepeso','Citricos')
...
desc_medicamento VARCHAR(50),
presentacion_medicamento VARCHAR(50)
)
;

INSERT INTO tb_medicamentos(desc_medicamento, presentacion_medicamento) VALUES
('IBUPROFENO x 200 MG', 'TABLETA'),
('PARACETAMOL x 500 MG', 'TABLETA')
...
id_medicamento INT,
dosis INT,
valor_frecuencia INT,
dias_tratamiento INT,
total INT /* =(24 / valor frecuencia) * dias_ tratamiento */
);




DROP TABLE IF EXISTS tb_frecuencia;
CREATE TABLE tb_frecuencia(
valor_frecuencia INT,
desc_frecuencia VARCHAR(20)
)
;
INSERT INTO tb_frecuencia(valor_frecuencia, desc_frecuencia) VALUES
('12', 'CADA 12 HORAS'),
('8', 'CADA 08 HORAS'),
('6', 'CADA 06 HORAS'),
('4', 'CADA 04 HORAS'),
...
INSERT INTO tb_roles (nom_rol) VALUES
('Paciente'),
('Médico'),
('Administrador'),
('Asistente'),
...
DROP TABLE IF EXISTS tb_nacionalidades;
...
;
SELECT * FROM tb_nacionalidades
;
INSERT INTO tb_nacionalidades(nom_pais, nacionalidad) VALUES
('AFGANISTÁN', 'AFGANA'),
('ALBANIA', 'ALBANESA'),
('ARGELIA', 'ARGELINA'),
('ARGENTINA', 'ARGENTINA'),
...
CREATE TABLE tb_horariomed(
id_med INT,
fecha DATE,
hora TIME,
estado INT /* 0-disponible , 1-reservado */
)
;
SELECT  * FROM tb_horariomed
;


INSERT INTO tb_horariomed(id_med, fecha, hora, estado) VALUES
('1', '2025-11-10', '09:00', '0'),
('1', '2025-11-10', '10:00', '0'),
('1', '2025-11-10', '11:00', '0'),
('1', '2025-11-10', '12:00', '0'),
('1', '2025-11-10', '13:00', '0'),
('1', '2025-11-12', '09:00', '0'),
('1', '2025-11-12', '10:00', '0'),
('1', '2025-11-12', '11:00', '0'),
('1', '2025-11-12', '12:00', '0'),
('1', '2025-11-12', '13:00', '0'),
('1', '2025-11-14', '15:00', '0'),
('1', '2025-11-14', '16:00', '0'),
('1', '2025-11-14', '17:00', '0')
...
INSERT INTO `tb_departamento` (`id_depart`, `nom_depart`) VALUES
('01', 'Amazonas'),
('02', 'Áncash'),
('03', 'Apurímac'),
('04', 'Arequipa'),
...
SELECT nom_depart FROM tb_departamento WHERE id_depart = 15

;
/* Insertar Provincias  */

INSERT INTO tb_provincia (id_prov, nom_prov, id_depart) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
SELECT nom_prov FROM tb_provincia WHERE id_depart = 15
;
/* Insertar Distritos  */
...
INSERT INTO tb_distrito (id_dist, nom_dist, id_prov, id_depart) VALUES
...
SELECT e.nom_depart AS Departamento, v.nom_prov AS Provincia, d.nom_dist AS Distrito
FROM tb_distrito d
INNER JOIN tb_provincia v ON v.id_prov = d.id_prov
INNER JOIN tb_departamento e ON e.id_depart = d.id_depart
WHERE d.id_prov = 1501;
...
CREATE TABLE tb_roles_menus (
    ...
    FOREIGN KEY (id_menu) REFERENCES tb_menus(id_menu)
);

-- Menú PRINCIPAL
INSERT INTO tb_menus (nombre_menu, url_menu, parent_id, orden) VALUES
('Inicio', 'home.php', NULL, 1),
('Agendar Citas', 'agendarcitaspre.php', NULL, 2),
('Triaje', 'triaje.php', NULL, 3),
('Horario del Médico', 'horariomedicamentos.php', NULL, 4),
('Atención Medicina Gen.', 'atencionmedica.php', NULL, 5),
('Atención Ginecologica', 'atencionginecologica.php', NULL, 6),
('Atención Perinatal', 'atencionperinatal.php', NULL, 7),
('Atención Psicologica', NULL, NULL, 8);

-- Submenús de Atención Psicologica (parent_id debe ser el id de "Atención Psicologica")
-- Primero, obtén el id de "Atención Psicologica":
-- SELECT id_menu FROM tb_menus WHERE nombre_menu = 'Atención Psicologica';
-- Supón que el id es 8 (ajusta si es diferente):

INSERT INTO tb_menus (nombre_menu, url_menu, parent_id, orden) VALUES
('Atención Psicológica', 'atencionpsicologica.php', 8, 1),
('Anamnesis', 'anamnesis.php', 8, 2);

-- Menú ADMINISTRACIÓN bb
INSERT INTO tb_menus (nombre_menu, url_menu, parent_id, orden) VALUES
('Registrar Medicos', 'regmedicos.php', NULL, 9),
('Gestión de Médicos', 'medicos.php', NULL, 10),
('Registrar Pacientes', 'regpacientes.php', NULL, 11),
('Registrar Medicamentos', 'regmedicamentos.php', NULL, 12),
('Gestión de Roles', 'roles.php', NULL, 13);

-- Menú CONFIGURACIÓN
INSERT INTO tb_menus (nombre_menu, url_menu, parent_id, orden) VALUES
('Configuración', NULL, NULL, 14),
('Cerrar Sesión', 'logout.php', NULL, 15);

INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 1);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 2);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 3);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 4);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 5);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 6);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 7);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 8);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 9);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 10);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 11);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 12);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 13);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 14);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 15);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 16);
INSERT INTO tb_roles_menus (id_rol, id_menu) VALUES (3, 17);


-- 1) Historial por paciente (puedes dejarlo NULL para pruebas)
CREATE TABLE tb_historial_paciente (
    id_historial_pac INT AUTO_INCREMENT PRIMARY KEY,
    id_paciente INT NULL,
    numdoc_paciente VARCHAR(20) NULL,
    codigo_historial VARCHAR(20) NULL UNIQUE,
    fecha_creacion DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_histpac_paciente FOREIGN KEY (id_paciente) REFERENCES tb_pacientes(id_paciente)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- 2) Episodios/visitas (todo nullable)
CREATE TABLE tb_historial_detalle (
    id_historial INT AUTO_INCREMENT PRIMARY KEY,
    id_historial_pac INT NULL,
    id_cita INT NULL,
    id_triaje INT NULL,
    id_atencion INT NULL,         -- tb_atengeneral
    id_medico INT NULL,
    id_especialidad INT NULL,
    id_cie10 INT NULL,            -- principal (si lo usas)
    motivo_consulta TEXT NULL,
    desc_diagnostico TEXT NULL,
    desc_antecedentes TEXT NULL,
    fecha_atencion DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
    estado INT NULL,              -- 1 activo / 0 archivado, puede ser NULL en pruebas
    INDEX idx_hd_pac (id_historial_pac),
    CONSTRAINT fk_hd_histpac FOREIGN KEY (id_historial_pac) REFERENCES tb_historial_paciente(id_historial_pac),
    CONSTRAINT fk_hd_cita FOREIGN KEY (id_cita) REFERENCES tb_citas(id_cita),
    CONSTRAINT fk_hd_triaje FOREIGN KEY (id_triaje) REFERENCES tb_triaje(id_triaje),
    CONSTRAINT fk_hd_atencion FOREIGN KEY (id_atencion) REFERENCES tb_atengeneral(id_atencion),
    CONSTRAINT fk_hd_medico FOREIGN KEY (id_medico) REFERENCES tb_medicos(id_medico),
    CONSTRAINT fk_hd_espec FOREIGN KEY (id_especialidad) REFERENCES tb_especialidades(id_especialidad),
    CONSTRAINT fk_hd_cie10 FOREIGN KEY (id_cie10) REFERENCES tb_cie10(id_cie10)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- 3) Diagnósticos por episodio (principal + secundarios, todos NULL-friendly)
CREATE TABLE tb_historial_diag (
    id_historial INT NULL,
    id_cie10 INT NULL,
    es_principal TINYINT NULL DEFAULT 0,
    nota TEXT NULL,
    PRIMARY KEY (id_historial, id_cie10),
    CONSTRAINT fk_hdiag_hist FOREIGN KEY (id_historial) REFERENCES tb_historial_detalle(id_historial),
    CONSTRAINT fk_hdiag_cie FOREIGN KEY (id_cie10) REFERENCES tb_cie10(id_cie10)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- 4) Enlazar tratamiento/receta al episodio (opcional, todo NULL)
ALTER TABLE tb_tratamiento
    ADD COLUMN id_historial INT NULL,
    ADD CONSTRAINT fk_trat_hist FOREIGN KEY (id_historial) REFERENCES tb_historial_detalle(id_historial);
...
CREATE TABLE tb_examenes_paciente (
    id_examen_paciente INT AUTO_INCREMENT PRIMARY KEY,
    id_historial INT NOT NULL,
    id_tipexam INT NOT NULL,
    cantidad INT NOT NULL DEFAULT 1,
    FOREIGN KEY (id_historial) REFERENCES tb_historial_detalle(id_historial),
    FOREIGN KEY (id_tipexam) REFERENCES tb_tipexam(id_tipexam)
);
ALTER TABLE tb_examenes_paciente
ADD observacion VARCHAR(255) NULL AFTER id_tipexam;
ALTER TABLE tb_examenes_paciente
