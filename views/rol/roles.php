...
<head>
  ...
  <link rel="icon" href="<?php echo BASE_URL; ?>/public/img/clinica.png" type="image/png">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <select id="selectRol" class="form-control" style="width: 100%;" multiple></select>
                        </div>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <select id="selectRolesNuevoUsuario" class="form-control" style="width: 100%;">
...
window.addEventListener('load', function() {
  ...
  $('#btnGuardarRol').on('click', function() {
    ...
    $.ajax({
      url: 'system/api/asignar-roles.php',
      method: 'POST',
  ...
  function cargarTablaRolesAcceso() {
    $.getJSON('system/api/listar-roles.php', function(data) {
  ...
  function cargarMenusConChecks(idRol) {
    $.getJSON('system/api/listar-menus.php', function(menus) {
      $.getJSON('system/api/listar-roles-menus.php?id_rol=' + idRol, function(permisos) {
  ...
  $('#formMenusRol').on('change', '.chkMenuRol', function() {
    ...
    $.post('system/api/actualizar-rol-menu.php', {
      id_rol: idRol,
      id_menu: idMenu,
      acceso: acceso
    }, function(resp) {
  ...
  $('#btnGuardarNuevoRol').on('click', function(){
    ...
    $.post('system/api/crear-rol.php', { nom_rol: nombre })
      .done(function(resp){
  ...
  $('#btnGuardarNuevoUsuario').on('click', function(){
    ...
    $.ajax({
      url: 'system/api/crear-usuario.php',
      method: 'POST',
  ...
  $('#btnActualizarUsuario').on('click', function() {
    ...
    $.ajax({
      url: 'system/api/editar-usuario.php',
      method: 'POST',
  ...
  $('#tablaUsuarios').on('click', '.btn-eliminar', function() {
    ...
    $.ajax({
      url: 'system/api/eliminar-usuario.php',
      method: 'POST',
      data: { dni_user: dni },
    })
    .done(function(resp){
...
function cargarUsuarios() {
  $.getJSON('system/api/listar-usuarios.php', function(data) {
