  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Atención Psicológica</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card card-info">            
              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <h2 class="section-title text-lg font-semibold p-2 mb-3">Datos de la Atención</h2>
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Observación General y de la Conducta</label>
                        <textarea class="form-control" rows="3"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Historia evolutiva de los transtorno o problemas principales</label>
                        <textarea class="form-control" rows="3"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Relato - Realidad Problemática</label>
                        <textarea class="form-control" rows="3"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>El Paciente y su entorno</label>
                        <textarea class="form-control" rows="3"></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Tareas o Actividades</label>
                        <textarea class="form-control" rows="3"></textarea>
                      </div>
                    </div>
                  </div>
